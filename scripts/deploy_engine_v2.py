...
Usage:
    python3 deploy_engine_v2.py deploy strategies/tech_30pct_drop.json --start 2026-01-01 --capital 100000
    python3 deploy_engine_v2.py deploy-portfolio portfolio.json --start 2026-01-01 --capital 1000000
    python3 deploy_engine_v2.py evaluate
    python3 deploy_engine_v2.py list
    python3 deploy_engine_v2.py stop <id>
"""
...
def main():
    ...
    if args.command == "deploy":
        ...
        # Regime deployments are separate (import from old engine)
        try:
            from deploy_engine import evaluate_all_regimes
